...
def export_to_excel(file_path, report_data: list, all_scan_data: dict, file_annotations: dict, 
    ...
    try:
        ...
        # ⚡ Bolt Optimization: Cache dict methods and Alignment instantiation to avoid O(N*M) loop overhead
        get_exif = exif_outputs.get
        get_indicators = indicators_by_path.get
        ...
        for row_idx, row_data in enumerate(report_data, start=2):
            ...
            indicators_full = get_indicators(path, "")
