...
from .scanner import (
    process_single_file,
    scan_worker_parallel,
    generate_comprehensive_timeline,
    run_exiftool,
    extract_text_for_indicators,
    detect_indicators,
    extract_revisions,
    extract_additional_xmp_ids,
    get_text_for_comparison
)
...
class PDFReconApp:
    ...
    def __init__(self, root):
        ...
        # --- Configuration Setup ---
        self.config_path = resolve_path("config.ini", base_is_parent=True)
    ...
    def _setup_logging(self):
        ...
        log_locations = [
            resolve_path("pdfrecon.log", base_is_parent=True),  # App directory
    ...
    def start_scan_thread(self, folder_path):
        ...
        scan_thread = threading.Thread(
            target=scan_worker_parallel,
            args=(folder_path, self.scan_queue, self.copy_executor, self._)
        )
    ...
    def _export_reader(self):
        ...
        try:
            ...
            for dep_name in dependencies:
                source_dep = resolve_path(dep_name, base_is_parent=True)
